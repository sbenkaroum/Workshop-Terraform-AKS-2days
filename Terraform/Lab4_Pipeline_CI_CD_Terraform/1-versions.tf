...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "SBM-RG-002"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "sbmstoreterra001"      # mettre le nom du compte de stockage créer dans le lab 1
